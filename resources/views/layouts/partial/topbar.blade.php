{{--<header class="main-header">--}}
    ...
    {{--<a href="index2.html" class="logo">--}}
        ...
        {{--<span class="logo-mini"><b>{{__('P')}}</b>{{__('anel')}}</span>--}}
        {{--<!-- logo for regular state and mobile devices -->--}}
        {{--<span class="logo-lg"><b>{{__('HANTA')}}</b></span>--}}
    {{--</a>--}}
        ...
        {{--<div class="navbar-custom-menu">--}}
            {{--<ul class="nav navbar-nav">--}}
                ...
                {{--<li class="dropdown tasks-menu">--}}
                    ...
                    {{--</a>--}}
                    {{--<ul class="dropdown-menu">--}}
                        {{--<li class="header">{{__('Change Language')}}</li>--}}
                        {{--<li>--}}
                            {{--<!-- inner menu: contains the actual data -->--}}
                            {{--<ul class="menu">--}}
                                {{--<li>--}}

                                    {{--<a href="{{route('admin.dashboard')}}" onclick="event.preventDefault();"></a>--}}
                                    {{--<a class="material-icons" href="{{url('/admin/locale/en')}}">--}}
                                        {{--<h3><i class="fa fa-fw fa-500px">{{__('English')}}</i></h3>--}}
                                        ...
                                        {{--</div>--}}
                                    {{--</a>--}}
                                    {{--<a class="material-icons" href="{{url('/admin/locale/fa')}}">--}}
                                        {{--<h3><i class="fa fa-fw fa-500px">{{__('Persian')}}</i></h3>--}}
                ...
                {{--<li class="dropdown user user-menu">--}}
                    {{--<a href="#" class="dropdown-toggle" data-toggle="dropdown">--}}
                        {{--<img src="{{asset('upload/user/'.auth()->user()->image)}}" class="user-image" alt="User Image">--}}
                        {{--<span class="hidden-xs">{{auth()->user()->name}}</span>--}}
                    {{--</a>--}}
                    {{--<ul class="dropdown-menu">--}}
                        {{--<!-- User image -->--}}
                        {{--<li class="user-header">--}}
                            {{--<img src="{{asset('upload/user/'.auth()->user()->image)}}" class="img-circle"--}}
                                 {{--alt="User Image">--}}
