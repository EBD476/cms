    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="index.html">
                ...
                <span style="">
                         <!-- dark Logo text -->
                         <img src="{{asset('backend/img/logo-icon.png')}}" alt="homepage" class="dark-logo">
                    <!-- Light Logo text -->
                    <img src="{{asset('backend/img/logo-light-icon.png')}}" class="light-logo" >{{__('HANTA')}}</span> </a>
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
        <!-- ============================================================== -->
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <!-- ============================================================== -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('upload/user/'.auth()->user()->image)}}" alt="{{auth()->user()->username}}" class="profile-pic"></a>
                    <div class="dropdown-menu dropdown-menu-right scale-up">
                        <ul class="dropdown-user">
                            <li>
                                <div class="dw-user-box">
                                    <div class="u-img"><img src="{{asset('upload/user/'.auth()->user()->image)}}" alt="{{auth()->user()->username}}">{{auth()->user()->username}}</div>
                                    <div class="u-text">
