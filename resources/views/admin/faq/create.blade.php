                        ...
                        <form role="form" method="post" action="{{route('faq.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputText" placeholder="{{__('Question')}}" name="question">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputFile">{{__('Answer')}}</label>
                                    <textarea type="text" class="form-control" id="exampleInputText" placeholder="{{__('Answer')}}" name="answer"></textarea>
