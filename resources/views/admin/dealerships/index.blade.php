                                    ...
                                    <table id="table"
                                        ...
                                        @foreach($dealerships as $key => $dealerships)
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox" @if ($dealerships ->hds_status) checked
                                                           @endif class="js-switch"
                                                           data-size="small" data-id="{{$dealerships->id}}">
                                                </td>
                                                <td>
                                                    <a href="{{route('dealership.edit',$dealerships->id)}}" class="btn btn-info btn-sm"><i class="ti-pencil"></i> </a>
                                                    <button data-id="{{$dealerships->id}}" type="button"
                    ...
                    $('.-form-delete').on('click', function (event) {
                        ...
                        swal({
                            ...
                            .then((willDelete) => {
                                if (willDelete) {
                                    $.ajax({
                                        url: '/admin/dealership-destroy/' + data.id,
                                        type: 'delete',
                                        data: data,
                                        dataType: 'json',
                                        async: false,
