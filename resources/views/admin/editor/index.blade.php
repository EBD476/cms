        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <a href="{{route('publish.create')}}" class="btn btn-primary">{{__('Add New Article')}}</a>
            ...
            $('#table').on('click', 'button', function (event) {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            $.ajax({
                                url: '/admin/article-destroy/' + data[0],
                                type: 'delete',
                                data: data,
                                dataType: 'json',
                                async: false,
...
//پاس کردن دیتا به کنترلر
                        $.ajax({
                            url: '/admin/article_update_status',
                            type: 'POST',
                            data: data,
                            dataType: 'json',
                            async: false,
