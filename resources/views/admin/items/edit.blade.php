                                            ...
                                            <div class="card-body">
                                                <form id="form1"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea type="text" class="form-control"
                                                                          name="sub_title"
                                                                          id="froala">value="{{$item->description}}"
                                                                </textarea></div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       name="sub_title" value="{{$item-> price}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <a href="{{route('items.index')}}"
                                                       class="btn badge-danger">Back</a>

                                                    <button type="submit"
                                                            class="btn badge-primary">{{__('Save')}}</button>
                                                </form>
